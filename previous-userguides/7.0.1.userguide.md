...
```HTML
<script src="https://prd.payment.amadeus.com/checkout/sdk/7.0.1/sdk-es2022.js" integrity="sha384-ZzdTtkgIRM9BVUtR3SAv65YPNZ6SRSZrXIgowpZChfpETYFemvOQRJ+69lMeFa8Q" crossorigin="anonymous"></script>
<link rel="stylesheet" href="https://prd.payment.amadeus.com/checkout/sdk/7.0.1/sdk.css" integrity="sha384-UllymVRYIljeXwI0hy6AyiCHNb9pHV/7SV3yASh9ThvMoyYf8QhHaDMYYN/wcqDK" crossorigin="anonymous">
```
...
```HTML
<link rel="stylesheet" href="https://prd.payment.amadeus.com/checkout/sdk/7.0.1/sdk-no-material.css" integrity="sha384-X3kDRaqqSJmv86WyKNWaYsK19nAaXeO4wZmacpMwGeh6xrdvBt9bIqSVok5kbTzi" crossorigin="anonymous">
```
...
- `mopsList`: Array of Objects `[{id, type, name, displayableName}]`, having the following properties:
  ...
  - `isMcpEnabled`: Boolean. Indicates whether Multi Currency Pricing (MCP) is supported for this particular payment method.  If this indicator is set to true, then you can propose MCP offers for this payment method.
...
| AmopFps                | FPS                          |                                                                                                                                                       |
| AmopFpx                | FPX                          | Bank selection dropdown with bank logos.                                                                                                                                                   |
| AmopGcash              | GCash                        |                                                                                                                                                       |
| AmopGhqr               | GhQR                         |                                                                                                                                                       |
| AmopGip                | GIP                          |                                                                                                                                                       |
| AmopGiropay            | Giropay                      |                                                                                                                                                       |
