...
```HTML
<script src="https://prd.payment.amadeus.com/checkout/sdk/4.4.0/sdk-es2015.js" integrity="sha384-gE6e6P4b6KGiOWIzd7kPW1Y0PFl81fs4HsZWiY9H2nBMl2IZ24U4QbffW2ilNOqz" crossorigin="anonymous"></script>
<link rel="stylesheet"  href="https://prd.payment.amadeus.com/checkout/sdk/4.4.0/sdk.css" integrity="sha384-PxY0l2o4ZNHU96cDetNVSb5wJDrxX63KNcT60xxnPjxvx4/uxfFxysATJleJHaaQ" crossorigin="anonymous">
```
...
```HTML
<link rel="stylesheet"  href="https://prd.payment.amadeus.com/checkout/sdk/4.4.0/sdk-no-material.css" integrity=" sha384-vMtS6sMPA0VISTd0vcbzCXrvd6xeF5kMwgbNSZLzt9O3DB3t1s3lu5Xandt9koCq" crossorigin="anonymous">
```
...
- `mopsList`: Array of Objects `[{id, type, name, displayableName}]`, having the following properties:
  ...
  -`isConfigValid`:Boolean. Indicate whether the payment method configuration is valid or not.
