...
Include the following scripts and CSS in your web page, replacing `<sdk_version>` by the version of the SDK that you want to use. Check Releases (#releases) section for available versions.

```HTML
<script src="https://prd.payment.amadeus.com/checkout/sdk/<sdk_version>/sdk-es2015.js" integrity="sha384-<js_hecksum>" crossorigin="anonymous"></script>
<link rel="stylesheet"  href="https://prd.payment.amadeus.com/checkout/sdk/<sdk_version>/sdk.css" integrity="sha384-<css_checksum>" crossorigin="anonymous">
```
...
```HTML
<link rel="stylesheet"  href="https://prd.payment.amadeus.com/checkout/sdk/<sdk_version>/sdk-no-material.css" integrity="sha384-<css_checksum>" crossorigin="anonymous">
```
...
|`environment`| Enumeration: `uat`, `pdt`, `mig`, `frt`, `skl`, `brd`, `prd` | *Mandatory* | Environment where the PPID was generated from. |
...
For a payment that includes QBRPoints, you can call this helper function to pass the QBRPoints informations:
...
__*AmadeusCheckout.setLoyalty(componentId, qbrLoyalty)*__
